        ...
        <div class="card-header">
            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                ...
                <div class="ml-auto d-inline-flex">
                    <li class="nav-item">
                        <a class="nav-link pt-1" href="<?php echo e(url('settings/sync-translation')); ?>"><i class="fa fa-refresh"></i> <?php echo e(trans('lang.sync_translation')); ?>
                ...
                <div class="col-9 tab-content" id="v-pills-tabContent">
                    ...
                    <?php $__currentLoopData = $langFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filename => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="tab-pane fade" id="v-pills-<?php echo e($filename); ?>" role="tabpanel" aria-labelledby="v-pills-<?php echo e($filename); ?>-tab">
                            <?php $__currentLoopData = Lang::get($filename.'',[],$tab); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
