                ...
                <div class="col-md-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body box-profile">
                            ...
                            <a class="btn btn-outline-<?php echo e(setting('theme_color')); ?> btn-block" href="mailto:<?php echo e(auth()->user()->email); ?>"><i class="fa fa-envelope mr-2"></i><?php echo e(auth()->user()->email); ?></a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
                ...
                <div class="col-md-9">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <?php echo $__env->make('settings.users.fields', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </div>
                            <?php echo Form::close(); ?>
