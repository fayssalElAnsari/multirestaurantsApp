...
<?php $__env->startSection('settings_content'); ?>
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="checkbox icheck">
                            <label class="w-100 ml-2 form-check-inline">
                                ...
                                <?php echo Form::checkbox('fixed_header', 'fixed-top', setting('fixed_header')); ?> <span class="ml-2"><?php echo trans("lang.app_setting_fixed_header_help"); ?></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="checkbox icheck">
                            <label class="w-100 ml-2 form-check-inline">
                                ...
                                <?php echo Form::checkbox('fixed_footer', 'fixed-bottom', setting('fixed_footer')); ?> <span class="ml-2"><?php echo trans("lang.app_setting_fixed_footer_help"); ?></span>
                            </label>
                        </div>
                    </div>
    ...
    <?php echo $__env->make('layouts.media_modal',['collection'=>'default'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
