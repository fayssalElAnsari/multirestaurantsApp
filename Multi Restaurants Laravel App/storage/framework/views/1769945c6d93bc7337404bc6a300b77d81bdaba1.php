...
<?php if(auth()->check()): ?>
    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <footer class="main-footer <?php echo e(setting('fixed_footer','')); ?>">
            ...
            <strong>Copyright © 2019 <a href="https://smartersvision.com"><?php echo e(setting('app_name')); ?></a>.</strong> All rights reserved.
        </footer>
    ...
    <nav class="nmain-header navbar navbar-expand <?php echo e(setting('nav_color','navbar-light bg-white')); ?> border-bottom">
        <div class="container">
            ...
            <ul class="navbar-nav">
                ...
                <?php echo $__env->make('layouts.menu',['icons'=>false], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </ul>
